                  ...
                  <div
                    ...
                    <div class='txtTinyMce-wrapper'
                      ...
                      <p
                        ...
                        <span style='font-size: 30px; color: #2b303a;'><strong>Verify your email address</strong></span>
                      </p>
                    </div>
                  </div>
                  <!--[if mso]></td></tr></table><![endif]-->
                ...
                <div
                  ...
                  <div align='center' class='button-container'
                    ...
                    <table width='100%' cellpadding='0' cellspacing='0' border='0'
                      ...
                      <tr>
                        <td style='padding-top: 40px; padding-right: 10px; padding-bottom: 0px; padding-left: 10px'
                            align='center'>
                          <v:roundrect xmlns:v='urn:schemas-microsoft-com:vml'
                                       xmlns:w='urn:schemas-microsoft-com:office:word' href=''
                                       style='height:46.5pt; width:135.75pt; v-text-anchor:middle;' arcsize='97%'
                                       stroke='false' fillcolor='#3b84d6'>
                            <w:anchorlock />
                            <v:textbox inset='0,0,0,0'>
                              <center style='color:#ffffff; font-family:Tahoma, sans-serif; font-size:16px'><![endif]-->
                    <div
                      style='text-decoration:none;display:inline-block;color:#ffffff;background-color:#3b84d6;border-radius:60px;-webkit-border-radius:60px;-moz-border-radius:60px;width:auto; width:auto;;border-top:1px solid #3b84d6;border-right:1px solid #3b84d6;border-bottom:1px solid #3b84d6;border-left:1px solid #3b84d6;padding-top:15px;padding-bottom:15px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;'>
                      <a href='${link}'
                         style='padding-left:30px;padding-right:30px;font-size:16px;text-decoration: none;color:#ffffff;display:inline-block;'><span
                        style='font-size: 16px; margin: 0; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;'><strong>Confirm</strong></span></a>
                    </div>
